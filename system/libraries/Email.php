...
class CI_Email {
	...
	var	$smtp_host		= "mail.mindztechnology.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "sales@mindztechnology.com";		// SMTP Username
	var	$smtp_pass		= "Mindz#987";		// SMTP Password
