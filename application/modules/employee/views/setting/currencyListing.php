...
if(!empty($listing)){
    ...
    <td><a  href="<?php echo base_url(); ?>ssa/admin/deletecurrency/<?php echo $value->a_CurrencyId; ?>" class="bug alert"></a> <a href="<?php echo base_url(); ?>ssa/admin/editcurrency/<?php echo $value->a_CurrencyId; ?>" class="link" for="atthFile"></a></td>
  </tr>
  <?php  $i++; }
