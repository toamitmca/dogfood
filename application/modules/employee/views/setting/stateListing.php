...
if(!empty($listing)){
    ...
    <td><a  href="<?php echo base_url(); ?>ssa/admin/deletestate/<?php echo $value->a_StateId; ?>" class="bug alert"></a> <a href="<?php echo base_url(); ?>ssa/admin/editstate/<?php echo $value->a_StateId; ?>" class="link" for="atthFile"></a></td>
  </tr>
  <?php  $i++; }
