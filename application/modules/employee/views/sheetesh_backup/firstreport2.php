...
<?php if(!empty($spnd)){
  ...
  <div class="colRow"><label>Custom Tag1</label> <select name="customtag1" id="customtag1" class="customtag1"><option value="1">Yes</option><option value="0">No</option></select></div>
	<div class="colRow"><label>Custom Tag2</label> <select name="customtag2" id="customtag2" class="customtag2"><option value="1">Yes</option><option value="0">No</option></select></div>
</div>
...
<?php if(!empty($spnd)){
    ...
    <div class="colRow"><label>Custom Tag1</label> <select name="customtag11" id="customtag11" class="customtag11"><option value="1">Yes</option><option value="0">No</option></select></div>
    <div class="colRow"><label>Custom Tag2</label> <select name="customtag21" id="customtag21" class="customtag21"><option value="1">Yes</option><option value="0">No</option></select></div>
</div>
...
<div>
    ...
    <div class="colRow"><label>Type</label> <select name="typetr12" id="typetr12" class="typetr12"><option value="2">Mileage </option></select></div>
...
<?php if(!empty($spnd)){
    ...
    <div class="colRow"><label>Custom Tag1</label> <select name="customtag112" id="customtag112" class="customtag112"><option value="1">Yes</option><option value="0">No</option></select></div>
    <div class="colRow"><label>Custom Tag2</label> <select name="customtag212" id="customtag212" class="customtag212"><option value="1">Yes</option><option value="0">No</option></select></div>
</div>
...
<div class="right_top" ><span class="buttonWrap"><a href="http://192.168.1.22/expense2/employee/claim" class="loadbtn iswantsave">Back to List</a>
...
<input type="text" name="cash_advance" id="cash_advance" onkeypress="return isNumber(event)"; onclick="return checkcashallowd(this.value)" onkeyup = "return calculateTotalAmount();" /></div>
<div class="col"><label>Pre Expence Amount <span class="WebRupee">Rs</span></label> 
...
<tr>
    ...
    <td>
    	<select  name="category[]" id="category_1" class="category">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName; ?>*1"><?php echo $value->t_SpndName; ?></option>
             <?php   }
    ...
    <td>
        <select  class="category" name="category[]" id="category_2">
          <option value="100">Select</option>
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName; ?>*2"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
  ...
  <tr>
    ...
    <td>
        <select  class="category" name="category[]" id="category_3">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName; ?>*3"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>     
        </select>
    </td>
  ...
  <tr>
    ...
    <td>
        <select class="category" name="category[]" id="category_4">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName;?>*4"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
    ...
    <td>
        <select  name="category[]" class="category" id="category_5">
          <option value="100">Select</option>
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName; ?>*5"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
...
<input type="button" name="save" id="save_expenses" onclick="return addtrueexpense22();" class="loadbtn bluebg" value="Save Expenses">
...
function addairtravelingexpence(){
   ...
   var totr                = $("#to12").val();
   var Report_Id           = $("#reportidtr12").val();
...
{ //alert('hii');
  ...
  console.log(addm);
  //$("#wantremove").empty();
  $(".myyclono tbody tr:last-child").after(addm);
}
