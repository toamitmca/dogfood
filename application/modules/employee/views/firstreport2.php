...
<input type="hidden" name="ricogtr1" id="ricogtr1" name="ricogtr1" value="">
  ...
  <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) {?>
                    <option value = "<?php echo $value->a_SpndngCatId; ?>" <?php if($value->a_SpndngCatId==651) {?> selected="selected" <?php } ?>><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "<option>No Records Founds</option>"; } ?>
  </select></div>
...
<!-- END-->
<!--==============++++###########################+=========== START DETAIULS POPUP JFROM HERE============-->
...
<table>
  <tr>
    ...
    <input type="hidden" name="pri1" id="file99999991" value="">
    <input type="hidden" name="pri2"  id="file99999992" value="">
    <input type="hidden" name="pri3"  id="file99999993" value="">
...
<tr>
    <td><input type="checkbox" id="check_1" class="chk_box" value="1" onclick="return getdetailsbtn(1)" >
      ...
      <select  name="category[]" id="category_1" class="category">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) { if($value->n_SingleExpLmt!=''){ $spn=$value->n_SingleExpLmt;} else { $spn='Null';}?>
                    <option value ="<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName .'@'.$spn; ?>*1"><?php echo $value->t_SpndName; ?></option>
             <?php   }
    ...
    <a href="#" class="comon" id="bug_1"></a> 
      <label class="link tttt9" id="1" ></label>
      <input type="hidden" class="report_file1" id="file11" value="">
      <input type="hidden" class="report_file2" id="file21" value="">
      <input type="hidden" class="report_file3" id="file31" value="">
  ...
  <tr>
    <td><input type="checkbox" maxlength="checkbox[]" id="check_2" value="2" onclick="return getdetailsbtn(2)" >
    ...
    <td>
        <select  class="category" name="category[]" id="category_2">
          <option value="100">Select</option>
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) { if($value->n_SingleExpLmt!=''){ $spn=$value->n_SingleExpLmt;} else { $spn='Null';}?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName.'@'.$spn; ?>*2"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
    ...
    <td>
      ...
      <label class="link tttt9" id="2"></label>
       <input type="hidden" class="report_file1" id="file12" value="">
      <input type="hidden" class="report_file2" id="file22" value="">
      <input type="hidden" class="report_file3" id="file32" value="">
  ...
  <tr>
    <td><input type="checkbox" id="check_3" value="3" onclick="return getdetailsbtn(3)">
    ...
    <td>
        <select  class="category" name="category[]" id="category_3">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) { if($value->n_SingleExpLmt!=''){ $spn=$value->n_SingleExpLmt;} else { $spn='Null';}?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName.'@'.$spn; ?>*3"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
    ...
    <td>
      ...
      <label class="link tttt9" id="3"></label>
      <input type="hidden" class="report_file1" id="file13" value="">
      <input type="hidden" class="report_file2" id="file23" value="">
      <input type="hidden" class="report_file3" id="file33" value="">
  ...
  <tr>
    <td><input type="checkbox" id="check_4" value="4" onclick="return getdetailsbtn(4)">
    ...
    <td>
        <select class="category" name="category[]" id="category_4">
            ...
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) { if($value->n_SingleExpLmt!=''){ $spn=$value->n_SingleExpLmt;} else { $spn='Null';}?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName.'@'.$spn;?>*4"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
    ...
    <td>
      ...
      <label class="link  tttt9" id="4"></label>
      <input type="hidden" class="report_file1" id="file14" value="">
      <input type="hidden" class="report_file2" id="file24" value="">
      <input type="hidden" class="report_file3" id="file34" value="">
  ...
  <tr class="helloer">
    <td><input type="checkbox" id="check_5" value="5" onclick="return getdetailsbtn(5)">
    ...
    <td>
        <select  name="category[]" class="category" id="category_5">
          <option value="100">Select</option>
            <?php if(!empty($policyAssign)){
                foreach ($policyAssign as $key => $value) { if($value->n_SingleExpLmt!=''){ $spn=$value->n_SingleExpLmt;} else { $spn='Null';}?>
                    <option value = "<?php echo $value->a_SpndngCatId.'-'.$value->t_SpndName.'@'.$spn; ?>*5"><?php echo $value->t_SpndName; ?></option>
             <?php   }
                }else{ echo "No Records Founds"; } ?>
        </select>
    </td>
    ...
    <td>
      ...
      <label class="link tttt9" id="5" ></label>
      <input type="hidden" class="report_file1" id="file15" value="">
      <input type="hidden" class="report_file2" id="file25" value="">
      <input type="hidden" class="report_file3" id="file35" value="">
...
<div class="popupsecondh" id="atthFil">
  ...
  <!--   <input class="boxtu" type="text"  name="nametest" value=""> -->
   <label class="btn next" for="photoimg"> <input type="file" name="rept_file1" id="99999991"  onchange="return hello(99999991)"></label>
    <label class="btn next" for="photoimg"><input type="file" name="rept_file1" id="99999992"  onchange="return hello(99999992)"></label>
   <label class="btn next" for="photoimg"> <input type="file" name="rept_file1" id="99999993"  onchange="return hello(99999993)"></label>
...
function savereportexp(){
  ...
  var buttonType          = 'save';
  var attchment1         =$('#file99999991').val();
  var attchment2         =$('#file99999992').val();
  var attchment3         =$('#file99999993').val();
...
if(chaim_period_form==""){
  ...
  if(kancha ==''){
      var myData  = {'report_name':report_name, 'report_type':report_type, 'status':status,'chaim_period_form':chaim_period_form,'cash_advance': cash_advance, 'chaim_period_to':chaim_period_to,'description':description,'n_status':buttonName,'b_IsVoilated':b_IsVoilated,'buttonType':buttonType,'grandtotal':grandtotal,'attchment1':attchment1,'attchment2':attchment2,'attchment3':attchment3};
  }else{
  ...
  function calculateTotalAmount(){
    ...
    for (var i = 1; i < forcount; i++) {
     ...
     //  console.log(ammount1);
          var ammount122=  parseFloat(ispopup.substring(ispopup.lastIndexOf("@")+1));
       console.log(ammount122);
                ...
                if(ammount122 < amount){
                 ...
                 $("#bug_"+i).addClass("bug");
                  $(".bug").attr('title',  'Your Expence is exceeds from policy Report Max Amount');
      ...
      total  = parseFloat(preexpense)+parseFloat(total); 
...
function addtrueexpense22(){
  //alert('rahul');
   ...
   var report_file2=[];
   var report_file3=[];
   var i=k=j=x=l=m=y=s=vs=fone=ftwo=fthree=0;
    ...
    $(".violationstatus").each(function(){
     ...
     $(".report_file1").each(function(){
        report_file1[fone] = $(this).val();
        fone++;
    });
      $(".report_file2").each(function(){
        report_file2[ftwo] = $(this).val();
        ftwo++;
    });
       $(".report_file3").each(function(){
        report_file3[fthree] = $(this).val();
        fthree++;
    });
 ...
 var tagval      = JSON.stringify(tagval);
 var violationstatus = JSON.stringify(violationstatus);
 var report_file1 = JSON.stringify(report_file1);
 var report_file2 = JSON.stringify(report_file2);
 var report_file3 = JSON.stringify(report_file3);
 ...
 var Report_Id   = parseInt($("#myreportId").html());
 if(Report_Id !='NaN'){
    var mydata  = {'categoryval':categoryval, 'datevalval':datevalval, 'amountval':amountval,'merchantval':merchantval,'purpose':purpose,'reimbval': reimbval, 'tagval':tagval,'Report_Id':Report_Id,'violationstatus':violationstatus,'report_file1':report_file1,'report_file2':report_file2,'report_file3':report_file3};
 }else{
    Report_Id   = 0; 
    var mydata  = {'categoryval':categoryval, 'datevalval':datevalval, 'amountval':amountval,'merchantval':merchantval,'purpose':purpose,'reimbval': reimbval, 'tagval':tagval,'Report_Id':Report_Id,'violationstatus':violationstatus ,'report_file1':report_file1,'report_file2':report_file2,'report_file3':report_file3};
 }
...
$('.tttt9').on('click',function(){
  var expense_id= $(this).attr('id');
  
  var app_tr='';
  app_tr+="<tr><td>Expense"+expense_id+"</td><tr>";
    app_tr+="<tr>";
    app_tr+="<td><label class=btn for=photoimg><input type=file onchange='return hello(1"+expense_id+")' name='dept_name_search' class='dept_namesheetesh file_btn' id='1"+expense_id+"'></label></td> </tr>";
   app_tr+="<tr><td><label class=btn for=photoimg><input type=file onchange='return hello(2"+expense_id+")' name='dept_name_search' class='dept_namesheetesh file_btn' id='2"+expense_id+"'></label></td></tr>";
    app_tr+="<tr><td><label class=btn for=photoimg><input type=file onchange='return hello(3"+expense_id+")' name='dept_name_search' class='dept_namesheetesh file_btn' id='3"+expense_id+"'></label></td>";
     app_tr+="</tr>"
$('#tblDept tbody').append(app_tr);
});

/*$('.dept_namesheetesh').on('click',function(){
  alert('hello');
...
/*$('.dept_namesheetesh').on('onchange',function(){
  var expense_id= $(this).attr('id');
  alert('hello');
  alert(expense_id);
...
function getdetailsbtn(detailscount)
{ var detailscounts=detailscount;
  //alert(detailscounts);


  var detailsid = $("#getrtrnid_"+detailscounts).val();
...
if(detailsid!='')
  ...
  {
    alert("You have to Save Expenses");
  }
