...
?>
  ...
  <tr>
        ...
        <td><input id="datepicker-example1s5"  class="dat date" name="date[]" type="text" value="<?php echo date('d M, Y', strtotime($Myvalue->d_Date)); ?>" ></td>
...
function addnewexprow(){
    ...
    +'<td><img src="<?php echo base_url();?>assects/images/icons/RupeesIcon.png"></td>'
    +'<td><select  name="category" id="category_'+mycount+'"><option value="0">Select</option> <?php foreach ($policyAssign as $key => $value) {echo "<option value=".$value->n_SingleExpLmt.">".$value->t_SpndName."</option>";}?></select></td>'
    +'<td><input id="datepicker-example1s5" class="dat date_5 datepicker_all" name="date_'+mycount+'" type="text"></td>'
