...
<table>
  ...
  <tr>
    ...
    <td><a class="dateColor"><span class="size_small">23-Dec-14,</span>&nbsp; <span class="size_small">25-Dec-14,</span></a></td>
    <td><a class="priceColor">R 245.00</a></td>
    <td><a>Open</a></td>
  </tr>
  <tr>
  	<td><input type="checkbox"  /></td>
...
<input type="text" name="monthlyexp" id="monthlyexp" value="<?php echo $policyname->n_MaxRptAmt ;?>">
 ...
 <tr>
  ...
  <tr>
    <td><input type="checkbox" maxlength="checkbox[]" id="check_2"></td>
    <td><img src="<?php echo base_url();?>assects/images/icons/RupeesIcon.png"/></td>
    <td><span class="data_category_2">Meal</span></td>
    <td>
    	<span class="data_date_2">12-12-12</span>
    </td>
    <td>
    	<span class="data_amount_2">2000</span>
    </td>
    <td>
    	<span class="data_merchant_2">Merchant Name</span>
    </td>
    <td>
    	<span class="data_purpose_2">Purpose Name</span>
    </td>
    <td>
    	<span class="data_reimb_2">Yes</span>
    </td>
    <td>
    	<span class="data_tag_2">Yes</span>
    </td>
    <td>
    	<a href="#" class="" id="bug_2"></a>
    	<label class="link" ></label>
