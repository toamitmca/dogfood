<section class="main_caintainer">
 ...
 <div class="rightSide">
  ...
  <form action="<?php echo base_url();?>ssa/superadmin/resetpass/" method="post">
...
function checkpass()
  {
    ...
    if(oldpass!='')
    {
      ...
      $.ajax({
        url: MybaseUrl+'ssa/superadmin/reset/',
        type: 'POST',
        dataType: 'json',
        data: {'opass':oldpass},
      ...
      $("#old_password").after('<span class="error_one">please Enter Password</span>');
