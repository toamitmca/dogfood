...
<ul class="leftmenu">
	...
	<li><a href="#form3" onclick="return getallcatbusiness(); tab(this);" >Spending Limit</a></li>
	<li><a href="#form4" onclick="appendnewcat();" >Spending Categories Limits</a></li>
</ul>
</div>


<!--<div class="leftSide"> getallcatbusiness()
<ul class="leftmenu">
