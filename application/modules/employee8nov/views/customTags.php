...
<div align="right"><span class="buttonWrap"><a href="" class="loadbtn bluebg">Add Tag 1</a></span>
</div>
<div class="col"><input type="text" placeholder="Text" id="t1" /><input type="text" placeholder="Text2" id="t2" /></div>
