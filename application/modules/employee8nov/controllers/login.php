...
class Login extends MX_Controller {
  ...
  public function index(){
       ...
       $this->form_validation->set_rules('username', 'Email', 'trim|required|min_length[5]|xss_clean|valid_email');
   		 $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[5]|max_length[255]|xss_clean');
   			if($this->form_validation->run() != false){
   				$parameter = array(  'p_mode'      => 'Selectlogin',
                                'a_EmpId'    => 'null',
          ...
          if($response =='Something Went Wrong'){
					...
					$base_url  = base_url();
   					redirect($base_url.'employee/dashboard/index');
   					exit();												
   				}
