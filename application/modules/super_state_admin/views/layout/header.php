...
<div class="headright">
<div class="topright"><div class="login_top"><p>Welcome <?php echo $data['Name']; ?> <span>Last Login: <?php echo $data['lastLogin']; ?></span><span><a href="<?php echo base_url();?>super_state_admin/logout/">Logout</a></span></p></div></div>
<nav class="nav">
<ul>
...
<li><a href="<?php echo base_url();?>super_state_admin/business/">Business</a></li>
<li><a href="employee_1.php">Employee</a></li>
<li><a href="#">Admins</a></li>
<li><a href="#">Profile</a></li>
<li><a href="#">Spending Analysis</a></li>
<li><a href="<?php echo base_url();?>super_state_admin/setting/">Settings</a></li>
</ul>
