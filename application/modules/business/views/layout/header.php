...
<div class="topright">
    <div class="login_top">
        <p><b>Welcome</b> <?php if(!empty($data['businessFirstName'])){ echo ucfirst($data['businessFirstName'].' '.$data['businessLastName']); }?>
            <span style="display:inline-block;">[<a href="<?php echo base_url();?>admin/logout/">Logout</a>]</span>
            <span>Last Login:<?php echo  date("d-M-Y g:i A", strtotime($data['Last_login']));?></span></p>
    </div>
</div>
<nav class="nav">
<?php echo mymenu(2);?>
<span class="iconRight" style="display: none;"><a href="#" class="quest_icon" title="Help"></a> <a href="<?php echo base_url();?>admin/logout" class="ficon" title="Logout"></a></span>
</nav>
</div>
</header>
