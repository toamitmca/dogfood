...
<p>Last Update 25/12/2014, by <?php echo $firstName.' '.$lastName; ?></p>
<div class="reportInner">
<ul>
<li><span class="circle" >&nbsp;</span>
<h4>Open</h4>
<p>25/12/2014 <small>By <?php echo $firstName.' '.$lastName; ?></small></p>
</li>
<li><span <?php if($repStatus=='submit') { ?> class="circle" <?php }else { ?> class="circle" style="background:#CCCCCC;" <?php } ?>>&nbsp;</span>
<h4></h4>
<p>25/12/2014 <small>By Manish Gupta</small></p>
</li>
<li><span <?php if($repStatus=='Reimbursed') { ?> class="circle" style="background:green;" <?php } else { if($approved==1) {?>  class="circle" <?php } else { ?> class="circle" style="background:#cccccc;"  <?php   } } ?>   >&nbsp;</span>
<h4>Approved</h4>
<p>25/12/2014 <small>By <?php echo $firstName.' '.$lastName; ?></small></p>
</li>
<li><span  <?php if($repStatus=='Reimbursed') { ?> class="circle" <?php }else { ?> class="circle" style="background:#CCCCCC;" <?php } ?>>&nbsp;</span>
<h4>Reimbursed</h4>
<p>25/12/2014 <small>By <?php echo $firstName.' '.$lastName; ?></small></p>
</li>
</ul>
