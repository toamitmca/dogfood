...
<div class="rightSide">
	<div>
		<span class="buttonWrap">
			<a href="<?php echo base_url(); ?>business/dashboard/admin/" class="loadbtn bluebg">Add Business Admin</a>
		</span>
		<div class="fix"></div>
	</div>
	<?php 
...
<?php echo $this->session->flashdata('message');?>
	...
	<tbody>
		...
		<div class="edit_policy1">  <!-- createb by rahul yadav 10 dec 2014 -->
	<?php   if($amountRange <0){
    $amountRange='';
   }
   else{
$amountRange =number_format($amountRange, 2, '.', '');
	...
	<?php foreach ($role as $key1 => $value1) {
		...
		<tr><td><input type="checkbox" name="edit_policy[]" <?php echo $check; ?> value="<?php echo $value1->a_RoleAccessId; ?>"><?php echo $value1->t_AccessName; ?></td><td>

<?php if($value1->a_RoleAccessId==5){ ?> </td><td>< Rs <input style="width:30%;" type="text" name="amount" id="amount" value="<?php echo $amountRange; ?>"/>  <?php }?></td></tr>
	...
	<div class="right_top">
		<span class="buttonWrap">
			<button type="submit" class="loadbtn bluebg" name="submit" id="submit">Update </button>
		</span>
		<div class="fix"></div>
	</div>
