      ...
      <div id="form1" style="display:block">
        <div class="right_top"><span class="buttonWrap"></span>
          ...
          <span class="buttonWrap_back">
      			<!-- <a href="" class="loadbtn bluebg">Back to</a> --></span><span class="buttonWrap"> <a href="<?php echo base_url(); ?>business/dashboard/policyadd" id="addpolicynew" class="loadbtn bluebg">New Policy</a></span> 
      ...
      <div id="form2">
        <div >
          ...
          <div class="formPreExp">
            ...
            <div> <span class="buttonWrap"><a class="loadbtn bluebg mileage">Save Peroid Limits</a></span>
              <div class="fix"></div>
            </div>
          </div>
        </div>
