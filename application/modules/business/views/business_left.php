...
<ul class="leftmenu">
	...
	<li><a href="#form211" onclick="tab(this);" >Department</a></li>
	<li><a href="#form3" onclick="tab(this);" >Spending category</a></li>
	<li><a href="#form4" onclick="tab(this);" >Custom tag</a></li>
	<li><a href="#form5" onclick="tab(this);" >Reimbursement</a></li>
</ul>
</div>
