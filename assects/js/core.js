    ...
    $('#datepicker-example1').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s1').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s2').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s3').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s4').Zebra_DatePicker({
		format: 'd M, Y'});
    $('#datepicker-example1s5').Zebra_DatePicker({
		format: 'd M, Y'});
	$('#datepicker-example1s6').Zebra_DatePicker({
		format: 'd M, Y'});

	$('.datepicker_all').Zebra_DatePicker({
		format: 'd M, Y'});

    $('.datepicker_new').Zebra_DatePicker({
        format: 'd M, Y'});
	
	$('.datepicker_all').unwrap();
$('.datepicker_all').parent().wrapInner('<span class="oldnewspan" style="position:relative; display:inline-block"></span>');
